...
import {
  Plus, Users, Home as HomeIcon, Receipt, DollarSign,
              ...
              <div className="flex gap-2">
                {['10', '12', '15'].map((opt) => (
                  <button
                    ...
                    className={`flex-1 py-2 text-sm rounded-lg border transition-all ${globalTipOption === opt
                ...
                <button
                  ...
                  className={`flex-1 py-2 text-sm rounded-lg border transition-all ${globalTipOption === 'custom'
                      ? 'bg-emerald-600 border-emerald-600 text-white font-bold'
                      : 'bg-white border-gray-200 text-gray-600 hover:bg-gray-50'
                    }`}
                >
                ...
                {participants.map(p => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 py-2 text-sm rounded-lg border transition-all flex items-center justify-between ${isSelected
    ...
    <div className="min-h-screen bg-slate-50 pb-24 font-sans text-gray-900">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-md mx-auto px-4 py-3 flex justify-center items-center">
          <div className="flex items-center gap-3">
            {/* Logo */}
            {/* Note: Ensure 'logo.png' is placed in the 'public' folder for Next.js */}
